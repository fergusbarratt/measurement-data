...
get_line = lambda p_ind, L: f"source /work2/08522/barratt/frontera/miniconda3/etc/profile.d/conda.sh && conda activate measurement_analysis && python test.py {p_ind} {L}\n"
